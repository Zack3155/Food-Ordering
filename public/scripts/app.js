  ...
  return (`<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            <h1 class="display-6 payment-title">Add Payment</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                ...
                <div class="card-header">
                    <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                        ...
                        <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                            <li class="nav-item"> <a data-toggle="pill" href="#credit-card" class=" credit-size bg-to-blue"> <i class="fas fa-credit-card mr-2 "></i> Credit Card </a> </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                            <form role="form" onsubmit="event.preventDefault()">
                                ...
                                <div class="card-footer"> <button type="button" class="subscribe btn bg-to-blue btn-block shadow-sm" > Confirm Payment </button>
                            </form>
                        </div>
                    </div> <!-- End -->
                    <!-- Paypal info -->
